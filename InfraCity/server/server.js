...
let connectDB;
let basicRoutes, authRoutes, userRoutes, seedRoutes, infrastructureRoutes, metricsRoutes, issueRoutes, roadSegmentRoutes, intersectionAnalysisRoutes, decongestionPlanRoutes, taskRoutes, analyticsRoutes, planningSessionRoutes, reportRoutes;
...
// Load database config at top level
try {
...
try {
  ...
  infrastructureRoutes = require("./routes/infrastructureRoutes");
  metricsRoutes = require("./routes/metricsRoutes");
  issueRoutes = require("./routes/issueRoutes");
  roadSegmentRoutes = require("./routes/roadSegmentRoutes");
  intersectionAnalysisRoutes = require("./routes/intersectionAnalysisRoutes");
  decongestionPlanRoutes = require("./routes/decongestionPlanRoutes");
  taskRoutes = require("./routes/taskRoutes");
  analyticsRoutes = require("./routes/analyticsRoutes");
  planningSessionRoutes = require("./routes/planningSessionRoutes");
